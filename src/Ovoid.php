...
class OVOID
{
     ...
     */
    public function curl($url, $fields = null, $headers = null)
         {
             $ch = curl_init();
    ...
    public function curl2($url, $fields = null, $headers = null)
        {
          $ch = curl_init();
          curl_setopt($ch, CURLOPT_URL, $url);
          curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
     ...
     public function curlget($url, $fields = null, $headers = null)
         {
             $ch = curl_init();
             curl_setopt($ch, CURLOPT_URL, $url);
             curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    ...
    public function login2FA($mobile_phone)
    {
      ...
      //  $ovo[] = 'App-Version: '.Meta::APP_VERSION;
        $ovo[] = 'App-Version: 2.9.1';
        $ovo[] = 'app-id: '.Meta::APP_ID;
        $ovo[] = 'Connection: Keep-Alive';
        $ovo[] = 'cs-session-id: ';
        $ovo[] = 'OS: Android';
        $ovo[] = 'User-Agent: okhttp/3.11.0';
        $mobile_phone = strval($mobile_phone);

       return $this->curl(OVOID::BASE_ENDPOINT . 'v2.0/api/auth/customer/login2FA', '{"deviceId":"'.$device.'","mobile":"'.$mobile_phone.'"}', $ovo)->getResponse();
    }
    ...
    public function login2FAVerify($refId, $verificationCode, $mobilePhone)
    {
      ...
      return $this->curl2(OVOID::BASE_ENDPOINT . 'v2.0/api/auth/customer/login2FA/verify', $data, $ovo)->getResponse();
    ...
    public function loginSecurityCode($securityCode, $updateAccessToken)
    {
      ...
      //  $ovo[] = 'App-Version: '.Meta::APP_VERSION;
        ...
        $data = [
          ...
          $data = json_encode($data);
        return $this->curl2(OVOID::BASE_ENDPOINT . 'v2.0/api/auth/customer/loginSecurityCode/verify', $data, $ovo)->getResponse();
    ...
    {
        $ch = new Curl;
    //    return $this->curl2(OVOID::BASE_ENDPOINT . 'v2.0/api/auth/customer/login2FA/verify', null, $ovo)->getResponse();
